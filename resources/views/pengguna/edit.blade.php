...
@section('title')
<div class="card-header" style="margin-left: 8px;" ><h3>Tambah Pengguna</h3></div>
@endsection
@section('content')
				...
				<div class="col-md-12 col-sm-12 col-xs-12" >
					<div class="x_content" style="background-color: black; color:white; length:100%;  border-radius:5px;">
						<ul class="nav nav-tabs bar_tabs" role="tablist">
                            ...
                            <li role="presentation" class=""><a href="{!! url('/pengguna/senarai')!!}"> <span class="visible-xs"></span><i class="fa"></i>Senarai Nama Pengguna &nbsp;&nbsp; </a></li>
                            <li role="presentation" class=""><a href="{!! url('/pengguna/tambah')!!}"><span class="visible-xs"></span><i class="fa">&nbsp;</i><b>Tambah Pengguna</b></a></li>
                            <li role="presentation" class="active"><a href="{!! url('/pengguna/edit/'.$user->id)!!}"><span class="visible-xs"></span><i class="fa">&nbsp;</i><b>Tambah Pengguna</b></a></li>
